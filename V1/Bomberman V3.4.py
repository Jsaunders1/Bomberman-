...
#                        print 'kicked'
#              for brick in bricks: 
#                    if bomb.rect.colliderect(brick.rect):
#                         bomb.velX = 0
#                         bomb.velY = 0
#              for wall in walls: 
#                    if bomb.rect.colliderect(wall.rect):
#                         bomb.velX = 0
#                         bomb.velY = 0
...
player2 = Player(1080,680,pygame.K_UP, pygame.K_DOWN, pygame.K_LEFT, pygame.K_RIGHT,pygame.K_RETURN)
colour = (0,0,0)
black = (0,0,0)
